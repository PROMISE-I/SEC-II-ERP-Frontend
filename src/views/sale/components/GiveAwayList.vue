        ...
        <el-row>
          <el-col :span="18">
            ...
            <span style="margin-left: 10px">
              ...
              <el-tag v-if="type === 5" effect="dark" type="info">等待销售单通过审核</el-tag>
            </span>
          </el-col>
          <el-col :span="6">
...
<script>
import {firstApprovalGiveAway, secondApprovalGiveAway} from "@/network/sale";
...
export default {
  ...
  methods: {
    ...
    approval(id) {
      ...
      if (this.type === 1) {
        firstApprovalGiveAway(config).then(res => {
          this.$emit("refresh")
          this.$message({
            message: '操作成功!',
            type: 'success'
        ...
        secondApprovalGiveAway(config).then(res => {
          this.$emit("refresh")
          this.$message({
            message: '操作成功!',
            type: 'success'

...
export const deleteBankAccount = config => request._get(testAPI.BANK_ACCOUNT_DELETE, config);
export const updateBankAccount = config => request._get(testAPI.BANK_ACCOUNT_UPDATE, config);
